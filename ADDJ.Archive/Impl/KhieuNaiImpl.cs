...
namespace GQKN.Archive.Impl
{
    ...
    public class KhieuNaiImpl : BaseImpl<KhieuNaiInfo>
    {
        ...
        public KhieuNaiImpl() : base() { }

        public KhieuNaiImpl(string connectionString) : base(connectionString) { }
        ...
        public int DongKhieuNai(int Id, string NoiDungXuLyDongKN, short TrangThai, DateTime NgayDongKN, int NguoiXuLyId, string NguoiXuLy)
        {
        ...
        public int UpdateActivity(int khieuNaiId, short TrangThai, int DoiTacXuLyId, int KhuVucXuLyId, int PhongBanXuLy,
        ...
        public DataTable QLKN_KhieuNaiChuaXuLyPhanViec_GetAllWithPadding(int TypeSearch, int LoaiKhieuNaiId, int LinhVucChungId, int LinhVucConId, int PhongBanId, int DoUuTien, int TrangThai, string NguoiXuLy, int StartPageIndex, int PageSize)
        {
            try
            {
                int TrangThai1 = (int)KhieuNai_TrangThai_Type.Chờ_xử_lý;
        ...
        public int QLKN_KhieuNaiChuaXuLyPhanViec_GetAllWithPadding_TotalRecords(int TypeSearch, int LoaiKhieuNaiId, int LinhVucChungId, int LinhVucConId, int PhongBanId, int DoUuTien, int TrangThai, string NguoiXuLy, int StartPageIndex, int PageSize)
        {
            try
            {
                int TrangThai1 = (int)KhieuNai_TrangThai_Type.Chờ_xử_lý;
        ...
        public DataTable QLKN_KhieuNaiBoPhanKhacChuyenVePhanViec_GetAllWithPadding(int TypeSearch, int LoaiKhieuNaiId, int LinhVucChungId, int LinhVucConId, int PhongBanId, int DoUuTien, int TrangThai, string NguoiXuLy, int StartPageIndex, int PageSize)
        {
            try
            {
                int TrangThai1 = (int)KhieuNai_TrangThai_Type.Chờ_xử_lý;
        ...
        public int QLKN_KhieuNaiBoPhanKhacChuyenVePhanViec_GetAllWithPadding_TotalRecords(int TypeSearch, int LoaiKhieuNaiId, int LinhVucChungId, int LinhVucConId, int PhongBanId, int DoUuTien, int TrangThai, string NguoiXuLy, int StartPageIndex, int PageSize)
        {
            try
            {
                int TrangThai1 = (int)KhieuNai_TrangThai_Type.Chờ_xử_lý;
        ...
        public DataTable QLKN_KhieuNaiSapQuaHanPhanViec_GetAllWithPadding(int TypeSearch, int LoaiKhieuNaiId, int LinhVucChungId, int LinhVucConId, int PhongBanId, int DoUuTien, string NguoiXuLy, int StartPageIndex, int PageSize)
        {
            try
            {
                int trangThai = (int)KhieuNai_TrangThai_Type.Đóng;
        ...
        public int QLKN_KhieuNaiSapQuaHanPhanViec_GetAllWithPadding_TotalRecords(int TypeSearch, int LoaiKhieuNaiId, int LinhVucChungId, int LinhVucConId, int PhongBanId, int DoUuTien, string NguoiXuLy, int StartPageIndex, int PageSize)
        {
            try
            {
                int trangThai = (int)KhieuNai_TrangThai_Type.Đóng;
        ...
        public DataTable QLKN_KhieuNaiQuaHanPhanViec_GetAllWithPadding(int TypeSearch, int LoaiKhieuNaiId, int LinhVucChungId, int LinhVucConId, int PhongBanId, int DoUuTien, string NguoiXuLy, int StartPageIndex, int PageSize)
        {
            try
            {
                int trangThai = (int)KhieuNai_TrangThai_Type.Đóng;
        ...
        public int QLKN_KhieuNaiQuaHanPhanViec_GetAllWithPadding_TotalRecords(int TypeSearch, int LoaiKhieuNaiId, int LinhVucChungId, int LinhVucConId, int PhongBanId, int DoUuTien, string NguoiXuLy, int StartPageIndex, int PageSize)
        {
            try
            {
                int trangThai = (int)KhieuNai_TrangThai_Type.Đóng;
            ...
            int StartPageIndex, int PageSize)
        {
            try
            {
                ...
                var lst = this.ExecuteQuery("usp_KhieuNai_GetTongSoKhieuNai_WithPage_v3", sqlParam);
                return lst;
            }
            catch (Exception ex)
            {
