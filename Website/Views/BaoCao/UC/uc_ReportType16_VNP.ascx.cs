...
{
    public partial class uc_ReportType16_VNP : System.Web.UI.UserControl
    {
        ...
        protected void lbReport_Click(object sender, EventArgs e)
        {
            ...
            dsDonViTiepNhan = ddlDoiTac.SelectedItem.Value;
            ...
            var page = "";
            if (lblReportType.Text == "bc_VNP_BaoCaoChiTietTheoChiTieuThoiGianGiaiQuyet")
            {
                page = "baocaotonghopchitiettheochitieuthoigiangiaiquyet.aspx?";
            }
            ...
            else
            {
                ...
                script = string.Format("<script type='text/javascript'> window.open(url=\"/Views/BaoCao/Popup/{1}fromPage=baocaotonghopchitiettheochitieuthoigiangiaiquyet&DsDonViTiepNhan={2}&fromDate={3}&toDate={4}&loaibc={5}\",\"_blank\", \"width=980, height=550,scrollbars=1,location=0\");</script>",
                    lblTittle.Text,
                    page,
                    dsDonViTiepNhan,
                    fromDate,
        ...
        //    listPhongBan = ServiceFactory.GetInstancePhongBan().GetListDynamic("*", "", "KhuVucId asc");
        ...
        //}
        // recursion function
        //private void CreateTreeView(List<PhongBanInfo> source, int parentID, TreeNode parentNode)
        //{
        //    List<PhongBanInfo> newSource = source.Where(a => a.ParentId.Equals(parentID)).ToList();
