<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="uc_ReportType14_VNP.ascx.cs" Inherits="Website.Views.BaoCao.UC.uc_ReportType14_VNP" %>
             ...
             <table class="tb2" width="100%">                       
                ...
                <tr>
                    <td>
                        Lấy theo</td>
                    <td colspan="3">
                        <div><asp:RadioButton ID="rdoTheoDonVi" runat="server" GroupName="rdoChonLoaiBc" Text="Theo đơn vị" AutoPostBack="True" /></div>
                        <div><asp:RadioButton ID="rdoTheoCaNhan" runat="server" GroupName="rdoChonLoaiBc" Text="Theo cá nhân" AutoPostBack="True" /></div>
                    </td>                    
                </tr>              
                <tr>
                    <td>Đơn vị </td>
                    <td colspan="3">
                        <asp:DropDownList ID="ddlDoiTac" runat="server" DataTextField="TenDoiTac" DataValueField="Id" Height="16px">
                        </asp:DropDownList>
                    </td>
                </tr>
                <tr>
                    <td>Cá nhân</td>
                    <td colspan="3">
                        <asp:DropDownList ID="ddlDSNguoiDungThuocNhom" runat="server" DataTextField="TenTruyCap" DataValueField="Id">
                        </asp:DropDownList>
                    </td>
                </tr>
                <tr>
