...
{
    public partial class ucReportType1_VAS : System.Web.UI.UserControl
    {
            ...
            {               
                ...
                switch (lblReportType.Text)
                {
                    case "bc_VAS_SoLieuPAKNDaXuLy":
                        ...
                        page = "baocaosolieupakndaxulyttptdv.aspx";
                        script = string.Format("<script type='text/javascript'> window.open(url=\"/Views/BaoCao/Popup/{1}?nguoiSuDung={2}&fromDate={3}&toDate={4}&loaibc={5}\",\"_blank\", \"width=980, height=550,scrollbars=1,location=0\");</script>", lblTittle.Text, page, nguoiSuDung, fromDate, toDate, loaibc);               
                        break;
                    ...
                    case "bc_VAS_TongHopPAKNVAS":
                        ...
                        script = string.Format("<script type='text/javascript'> window.open(url=\"/Views/BaoCao/Popup/{1}khuVucId={2}&fromDate={3}&toDate={4}&loaibc={5}&phongBanId={6}\",\"_blank\", \"width=980, height=550,scrollbars=1,location=0\");</script>", lblTittle.Text, page, TT_PTDV, fromDate, toDate, loaibc, PHONG_PTDV);
                        break;
                    case "bc_VAS_TongHopPAKNTheoNguoiDung":
                        page = "baocaotonghoppakntheonguoidungptdv.aspx?";
                        script = string.Format("<script type='text/javascript'> window.open(url=\"/Views/BaoCao/Popup/{1}doiTacId={2}&fromDate={3}&toDate={4}&loaibc={5}&phongBanId={6}\",\"_blank\", \"width=980, height=550,scrollbars=1,location=0\");</script>", lblTittle.Text, page, TT_PTDV, fromDate, toDate, loaibc, PHONG_PTDV);
                        break;
                    default:
                        page = "";
                        break;
