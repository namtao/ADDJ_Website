<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ucReportType6_VNPTTT.ascx.cs" Inherits="Website.Views.BaoCao.UC.ucReportType6_VNPTTT" %>
        ...
        <ContentTemplate>
            <table class="tb2" width="100%">                       
                ...
                <tr>
                    ...
                    <td colspan="3">
                        <asp:DropDownList ID="ddlVNPT" runat="server" DataTextField="TenDoiTac" DataValueField="Id">
                        </asp:DropDownList>                              
                    </td>                    
                </tr>              
                <tr>
