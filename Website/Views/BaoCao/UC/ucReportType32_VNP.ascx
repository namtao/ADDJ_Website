<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ucReportType32_VNP.ascx.cs" Inherits="Website.Views.BaoCao.UC.ucReportType32_VNP" %>
            ...
            <table class="tb2" width="100%">                       
                ...
                <td >                                        
                    <asp:DropDownList ID="ddlLoaiThueBao" runat="server">
                        <asp:ListItem Value="-1">--Chọn loại thuê bao--</asp:ListItem>
                ...
                <tr>
                    <td colspan="4">
                        <asp:RadioButtonList ID="rblReportType" runat="server" RepeatDirection="Horizontal">
                            <asp:ListItem Value="1"  Selected="True">Thống kê theo loại khiếu nại</asp:ListItem>
                            <asp:ListItem Value="2">Thống kê theo lĩnh vực chung</asp:ListItem>
                            <asp:ListItem Value="3">Thống kê theo lĩnh vực con</asp:ListItem>
                        </asp:RadioButtonList>
                    </td>
                </tr>
                <tr valign="top">                                    
