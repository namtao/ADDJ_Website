<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="uc_ReportType13_VNP.ascx.cs" Inherits="Website.Views.BaoCao.UC.uc_ReportType13_VNP" %>
        ...
        <ContentTemplate>
            <table class="tb2" width="100%">                       
                ...
                <tr>
                    ...
                    <td colspan="3">
                        <asp:DropDownList ID="ddlDoiTac" runat="server" DataTextField="TenDoiTac" DataValueField="Id">
                        </asp:DropDownList>                              
                    </td>                    
                </tr>              
                <tr>
