<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ucReportType15_VNPTTT.ascx.cs" Inherits="Website.Views.BaoCao.UC.ucReportType15_VNPTTT" %>
        ...
        <ContentTemplate>
            <table class="tb2" width="100%">                       
                ...
                <tr>
                    ...
                    <td colspan="3">
                        <asp:DropDownList ID="ddlDonVi" runat="server" DataTextField="TenDoiTac" DataValueField="Id">
                        </asp:DropDownList>                              
                    </td>                    
                </tr>              
                <tr>
