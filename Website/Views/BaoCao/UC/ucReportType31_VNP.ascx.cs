...
{
    public partial class ucReportType31_VNP : System.Web.UI.UserControl
    {
        ...
        protected void lbReport_Click(object sender, EventArgs e)
        {
            ...
            {
                string url = string.Format("/Views/BaoCao/Popup/baocaobieudososanhsoluonggiaiquyetkhieunai.aspx?reportType={0}&loaiKhieuNaiId={1}&linhVucChungId={2}&linhVucConId={3}&fromDate={4}&toDate={5}&doiTacId={6}&loaiThueBao={7}", reportType, loaiKhieuNaiId, linhVucChungId, linhVucConId, fromDate1, toDate1, khuVucId, loaiThueBao);
                if (url.Length > 1900)
                {
                ...
                else
                {
                    ...
                    {
                        script = string.Format("<script type='text/javascript'> window.open(url=\"/Views/BaoCao/Popup/baocaobieudososanhsoluonggiaiquyetkhieunai.aspx?reportType={0}&loaiKhieuNaiId={1}&linhVucChungId={2}&linhVucConId={3}&fromDate={4}&toDate={5}&doiTacId={6}&loaiThueBao={7}\",\"_blank\", \"width=980, height=550,scrollbars=1,location=0\");</script>", reportType, loaiKhieuNaiId, linhVucChungId, linhVucConId, fromDate1, toDate1, khuVucId, loaiThueBao);
                    }
                    else if (lblReportType.Text == "bc_VNP_ThongKeTongSoTienGiamTruTheo1KhoangThoiGian")
                    {
