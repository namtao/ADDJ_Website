...
{
    public partial class baocaotonghopsolieupakndangtondongttptdv : AppCode.PageBase
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                lbDate.Text = DateTime.Now.ToString("dd/MM/yyyy"); //string.Format("{0} - {1}", fromDate.ToString("dd/MM/yyyy"), toDate.ToString("dd/MM/yyyy"));                                
                ...
                sNoiDungBaoCao = new BuildBaoCao().BaoCaoSoLuongPAKNDangTonDongTTPTDV(TT_PTDV, PHONG_PTDV, fromDate, toDate, isExportExcel);

                if (isExportExcel)
                {
                    export2excel("BaoCaoSoLuongPAKNDangTonDongTTPTDV_" + fromDate + "_" + toDate);
                }
            }
