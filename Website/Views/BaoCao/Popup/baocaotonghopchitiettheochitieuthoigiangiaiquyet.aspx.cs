...
{
    public partial class baocaotonghopchitiettheochitieuthoigiangiaiquyet : AppCode.PageBase
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                try
                {
                    ...
                    {
                        case "baocaotonghopchitiettheochitieuthoigiangiaiquyet":
                            ltTitle.Text = "BÁO CÁO CHI TIẾT THEO CHỈ TIÊU THỜI GIAN GIẢI QUYẾT";
                            sNoiDungBaoCao = BuildBaoCao2.BaoCaoTongHopChiTietTheoChiTieuThoiGianGiaiQuyet(dsDonViTiepNhan, fromDate, toDate);
                            break;
                    }
