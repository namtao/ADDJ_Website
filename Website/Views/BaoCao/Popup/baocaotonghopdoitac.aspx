<%@ Page Title="" Language="C#" MasterPageFile="~/Views/BaoCao/BaoCao.Master" AutoEventWireup="true" CodeBehind="baocaotonghopdoitac.aspx.cs" Inherits="Website.Views.BaoCao.Popup.baocaotonghopdoitac" %>
    ...
    <div runat="server" id="baocao" class="reportFont">
            <div id="reportContainer">
                ...
                <div style="text-align:center">
                    <h1>
                        BÁO CÁO TỔNG HỢP SỐ LIỆU PAKN <asp:Label ID="lblTenDoiTac" runat="server"></asp:Label>
                    </h1>                            
                ...
                <tr>                
                    ...
                    <th>SL đã xử lý<br />[3] = [3.1] + [3.2] + [3.3]</th>                   
                    <th>SL chuyển xử lý<br />[3.1]</th>
                    <th>SL chuyển phản hồi<br />[3.2]</th>
                    <th>SL đã đóng<br />[3.3]</th> 
                    <th>Số lượng đã xử lý quá hạn<br />[3.4]</th>               
                </tr>
                <%=sNoiDungBaoCao %>
            </table>
                ...
                <table border="0" width="100%">
                    ...
                    <tr valign="top">
                        <td style="border: 0px; text-align: center; font-weight: bold" colspan="2">                    
                        </td>  
        ...
        <div>
            ...
            <br />[3] = [3.1] + [3.2] + [3.3] : Tổng số khiếu nại đã được xử lý (chuyển ngang hàng/chuyển xử lý/chuyển phản hồi/đóng khiếu nại)            
            <br />[3.1] : Số lượng khiếu nại đã được chuyển xử lý
            <br />[3.2] : Số lượng khiếu nại đã được chuyển chuyển phản hồi
            <br />[3.3] : Số lượng khiếu nại người dùng đã đóng
            <br />[3.4] : Số lượng khiếu nại đã được xử lý nhưng quá hạn phòng ban quy định
