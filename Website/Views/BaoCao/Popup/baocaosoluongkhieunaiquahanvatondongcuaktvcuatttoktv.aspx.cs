...
namespace Website.Views.BaoCao.Popup
{
    ...
    /// Todo : Báo cáo số lượng khiếu nại quá hạn và tồn đọng
    /// </summary>
    public partial class baocaosoluongkhieunaiquahanvatondongcuaktvcuatttoktv : AppCode.PageBase
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                //sNoiDungBaoCao = new BuildBaoCao().GetSoLuongKNQuaHanVaTonDongCuaKTV(phongBanXuLyId, fromDate, toDate);

                if (loaibc == "excel")
                {
                    export2excel("BaoCaoSoLuongKNQuaHanVaTonDong" + fromDate + "_" + toDate);
