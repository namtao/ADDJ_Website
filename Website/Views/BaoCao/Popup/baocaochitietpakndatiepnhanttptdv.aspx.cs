...
{
    public partial class baocaochitietpakndatiepnhanttptdv : AppCode.PageBase
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                sNoiDungBaoCao = new BuildBaoCao().BaoCaoChiTietPAKNDaTiepNhanTTPTDV(TT_PTDV, PHONG_PTDV, fromDate, toDate, 1, Int32.MaxValue);

                if (loaibc == "excel")
                {
                    export2excel("BaoCaoChiTietPAKNDaTiepNhanTTPTDV" + fromDate + "_" + toDate);
                }
            }
