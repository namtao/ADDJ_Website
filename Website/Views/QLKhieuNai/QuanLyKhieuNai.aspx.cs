...
{
    public partial class QuanLyKhieuNai : Website.AppCode.PageBase
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                if (Request.QueryString["ctrl"] != null && !Request.QueryString["ctrl"].Equals(""))
                {
                    ...
                    string[] arr = Request.QueryString["ctrl"].Split('-');
                ...
                {
                    System.Web.UI.Control usc = this.LoadControl("/Views/QLKhieuNai/UserControls/NhomKNChoXL.ascx");
                    placeHolder.Controls.Add(usc);
                }
            }
