<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ListKNChuyenBoPhanKhac.ascx.cs"
    Inherits="Website.Views.QLKhieuNai.UserControls.ListKNChuyenBoPhanKhac" %>
    ...
    <table class="tbl_style" cellspacing="0" cellpadding="0" style='width: 2150px;'>
        ...
        <thead class="grid-data-thead">
           ...
           <th class="thead-colunm"  style ="white-space:nowrap;padding-left:5px;padding-right:5px;">
            ...
            <th class="thead-colunm"  style ="white-space:nowrap;padding-left:5px;padding-right:5px;width:150px;">
                Phòng ban xử lý
            </th>            
            <th class="thead-colunm" style ="white-space:nowrap;padding-left:5px;padding-right:5px;">
                Người xử lý
