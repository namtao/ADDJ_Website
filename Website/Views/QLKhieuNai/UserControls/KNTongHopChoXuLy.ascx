<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="KNTongHopChoXuLy.ascx.cs" Inherits="Website.Views.QLKhieuNai.UserControls.KNTongHopChoXuLy" %>
<%@ Register Src="~/Views/QLKhieuNai/UserControls/UcTopContent.ascx" TagName="UcTopContent" TagPrefix="UcTopContent" %>
<%@ Register Src="~/Views/QLKhieuNai/UserControls/UcFillter.ascx" TagName="UcFillter" TagPrefix="UcFillter" %>
<%@ Register Src="~/Views/QLKhieuNai/UserControls/PopupChoXuLy.ascx" TagName="PopupChoXuLy" TagPrefix="PopupChoXuLy" %>
...
<div class="nav_btn" style='border-top: 0px'>
    <ul>
        <li style="background: none;"><span id="titleChoXuLy" style="color: #4D709A; font-size: 15px; font-weight: bold;">Tất cả khiếu nại chờ xử lý</span></li>
