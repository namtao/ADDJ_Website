<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="KNChoXuLy.ascx.cs" Inherits="Website.Views.QLKhieuNai.UserControls.KNChoXuLy" %>
...
<div class="nav_btn" style='border-top: 0px'>
    <ul>
        <li style="background: none;"><span id="titleChoXuLy" style="color: #4D709A; font-size: 15px; font-weight: bold;">Danh sách khiếu nại chờ xử lý</span></li>
