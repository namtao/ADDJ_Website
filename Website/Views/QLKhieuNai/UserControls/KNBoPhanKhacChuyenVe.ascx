<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="KNBoPhanKhacChuyenVe.ascx.cs" Inherits="Website.Views.QLKhieuNai.UserControls.KNBoPhanKhacChuyenVe" %>
...
<div class="nav_btn" style='border-top: 0px'>
    ...
    <ul>
        <li style="background: none;"><span id="titleChuyenBoPhanKhac" style="color: #4D709A; font-size: 15px; font-weight: bold;">Danh sách khiếu nại bộ phận khác chuyển về</span></li>
                    ...
                    <div id="divScroll" style='overflow-x: scroll; height: auto;'>
                        <table class="tbl_style" cellspacing="0" cellpadding="0" style='width: 2180px;'>
                            <thead class="grid-data-thead">
                                ...
                                <th class="thead-colunm" style="white-space: nowrap; padding-left: 5px; padding-right: 5px;">Người được phản hồi
                                </th>
