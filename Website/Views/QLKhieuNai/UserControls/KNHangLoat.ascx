<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="KNHangLoat.ascx.cs" Inherits="Website.Views.QLKhieuNai.UserControls.KNHangLoat" %>
<%@ Register Src="~/Views/QLKhieuNai/UserControls/UcTopContent.ascx" TagName="UcTopContent"
    ...
    TagPrefix="ChiTietKN" %>
    <%@ Register Src="~/Views/QLKhieuNai/UserControls/ListKNSelectKNHangLoat.ascx" TagName="ListKNSelectKNHangLoat"
    TagPrefix="ListKNSelectKNHangLoat" %>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        $.getJSON('/Views/QLKhieuNai/Handler/Handler.ashx?key=22&catid=' + catid + '&pageSize=' + pageSize + '&startPageIndex=1', '', function (totalRecords) {
            if (totalRecords != '') {
    ...
    function pageselectCallback(page_index) {
        ...
        var catid = fnGetUrlParameter('catid');
        $.getJSON('/Views/QLKhieuNai/Handler/Handler.ashx?key=23&catid=' + catid + '&pageSize=' + pageSize + '&startPageIndex=' + curentPages, '', function (result) {
            if (result != '') {
    ...
    function GetTitle(totalRecords) {
        ...
        $.getJSON('/Views/QLKhieuNai/Handler/Handler.ashx?key=10&catid=' + catid, '', function (result) {
            if (result != '') {
                $('#titleChuyenHangLoat').html('Chuyển khiếu nại hàng loạt-' + result + " <span style=\"color: #FF0000;\">(" + addCommas(totalRecords) + ")</span>");
            }
    ...
    function ChuyenKhieuNai() {
        if (listID != '') {
            if (ValidatePhongBan()) {
                ...
                $.getJSON('/Views/QLKhieuNai/Handler/Handler.ashx?key=21&listID=' + listID + '&phongbanid=' + phongBan, '', function (result) {
                    if (result != '0') {
...
<div class="nav_btn" style='border-top:0px'>
    ...
    <ul>
        <li style ="background:none;"><span id ="titleChuyenHangLoat" style ="color:#4D709A;font-size:15px;font-weight:bold;">Chuyển khiếu nại hàng loạt</span></li>
        <li style="float: right;"><a href="javascript:ShowPoupPhongBan();"><span class="delete">
        Chuyển bộ phận khác
        </span></a> </li>
        <li style="float: right;"><a href="javascript:DongKhieuNai();"><span class="delete">
        Đóng khiếu nại
        </span></a> </li>
       <%-- <li style="float: right;"><a href="javascript:fnGetSetUrl('KNHangLoat');">
            <span class="delete">Chuyển KN hàng loạt</span></a> </li>
        <li class ="active" style="float: right;"><a href="javascript:fnGetSetUrl('ChuyenKN');">
            <span class="new">Chuyển khiếu nại</span></a> </li>
        <li style="float: right;"><a href="javascript:fnGetSetUrl('TruyVan');">
            <span class="back">Truy vấn</span></a></li>--%>
    </ul>
    <div class="div-clear">
    </div>
</div>
        ...
        <tbody>
            ...
            <tr valign="top">
                <td style="text-align: center">
                     <ListKNSelectKNHangLoat:ListKNSelectKNHangLoat ID="ListKNSelectKNHangLoat1" runat="server" />
                </td>
            </tr>
        </tbody>
    </table>
...
<div id="divPoupPhongBan" style="width: auto; height: auto; background: #fff; margin: 0 auto;
    ...
    <div id="div2" style="">
        <div class="nav_btn" style='background: none;'>
            <div style="margin-top: 10px;margin-left:10px; height: 250px; border-top: 1px solid #CCC; border-bottom: 1px solid #CCC;background: none;overflow-y: scroll;">
            ...
            <div style="margin-top: 10px; height: 100px; background: none;">
                ...
                <div class="inputstyle">
                    <div class="bg">
                        ...
                        <asp:TextBox ID="txtNote" MaxLength ="500" TextMode="MultiLine" Height ="50" Width ="100%" runat="server"></asp:TextBox>
                    </div>
                </div>
            </div>
            <ul>
