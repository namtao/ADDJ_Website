<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="KNDaPhanHoi.ascx.cs"
    Inherits="Website.Views.QLKhieuNai.UserControls.KNDaPhanHoi" %>
...
<div class="nav_btn" style='border-top: 0px'>
    <ul>
        <li style="background: none;"><span id="titleChuyenBoPhanKhac" style="color: #4D709A; font-size: 15px; font-weight: bold;">Danh sách khiếu nại đã phản hồi</span></li>
