<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Master_Default.master" CodeBehind="BaoCaoKPIGTGT_TheoDonViQuanLy.aspx.cs" Inherits="Website.BaoCao.BaoCaoKPIGTGT_TheoDonViQuanLy" %>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $(".openthis").on({click: function(e){
                ...
                window.open(link, "Báo cáo dịch vụ GTGT cho tập đoàn", "width=990,height=680,resizable=yes,toolbar=no,menubar=no,location=no,status=no,scrollbars=yes,top=30");
                e.preventDefault();
            }});
        });
    </script>
...
<asp:Content runat="server" ContentPlaceHolderID="HeaderCss">
    <style type="text/css">
        .tbl_head_report.report3 .colleft1 { width: 150px; }
        .tbl_style td span.number { display: block; text-align: right; }
        .rptContent { height: 500px; }
        .lst-check td{padding-right: 10px}
        .coltitle2{width: 70px;}
    </style>
</asp:Content>
    ...
    <div class="wrapper">
        <table class="tbl_head_report tb2 report3">
            <tr>
                ...
                <td class="coltitle coltitle2">Năm</td>
                <td class="colleft1">
                    <div class="selectstyle w200">
                        <div class="bg">
            ...
            <tr>
                ...
                <td colspan="4">
                    <asp:CheckBoxList CssClass="lst-check" ID="chkDonViBaoCao" RepeatDirection="Horizontal" runat="server">
                    </asp:CheckBoxList>
