<%@ Page Language="C#" MasterPageFile="~/Master_Default.master" AutoEventWireup="true"
    Inherits="admin_phongBan2PhongBan" CodeBehind="PhongBan2PhongBan.aspx.cs" %>
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body" style="border: none">
                        ...
                        <table border="0" cellpadding="0" cellspacing="0" width="100%">
                            ...
                            <tr>
                                <td style="width: 30%; text-align: center; padding-right: 10px">Danh sách phòng ban chuyển xử lý của
                                    <br />
                            ...
                            <tr>
                                <td style="text-align: center">
                                    <asp:Button ID="btLeaver" runat="server" CssClass="btn_style_button" Text="Xóa phòng ban chuyển xử lý được chọn >>" OnClick="btLeaver_Click" />
                                </td>
                                <td style="width: 70%; text-align: center">
                                    <asp:Button ID="btAddPhongBan2PhongBan" runat="server" CssClass="btn_style_button" Text="<< Thêm phòng ban chuyển xử lý được chọn" OnClick="btAddPhong_Click" />
                                </td>
                            </tr>
                            <tr>
                                <td style="height: 5px;"></td>
            ...
            <script type="text/javascript">
                function AutocompleteTenDangNhap() {
                    ...
                    $("#<%=txtTenDangNhap.ClientID %>").keydown(function (e) {
                        if (e.keyCode == '13') {
                            document.getElementById('<%=btAddPhongBan2PhongBan.ClientID%>').click();
                        }
                    });
