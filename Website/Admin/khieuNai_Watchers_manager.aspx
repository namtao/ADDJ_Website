<%@ Page Language="C#" MasterPageFile="~/admin/adminNotAJAX.master" AutoEventWireup="true" Inherits="admin_khieuNai_Watchers_manager" Title="Untitled Page" Codebehind="khieuNai_Watchers_manager.aspx.cs" %>
	...
	<tr>
		<td>
			<table cellpadding="0" cellspacing="0" style="width: 600px">
				...
				<tr>					<td style="text-align: left; width: 250px">Chọn NguoiSuDungId</td>
					<td style="text-align: left">
						<asp:DropDownList ID="ddlNguoiSuDungId" AutoPostBack="true" runat="server" OnSelectedIndexChanged="ddlNguoiSuDungId_SelectedIndexChanged"></asp:DropDownList>
					</td>
				</tr>
			</table>
		</td>
			...
			<table cellpadding="0" cellspacing="0" style="width: 100%">
				<tr>
					...
					<td align="right" style="width: 50%; text-align: right">
						<asp:Button ID="Button2" runat="server" CssClass="button" Text="Xóa" OnClick="btDelete_Click" Width="50px" OnClientClick="javascript:{return confirm('Bạn có muốn xóa KhieuNai_Watchers được chọn?');}" />
					</td>
				</tr>
			</table>
		</td>
		...
		<td style="text-align: center">
			<asp:GridView ID="grvView" runat="server" AutoGenerateColumns="False" Width="100%"
				...
				<Columns>
					...
					<asp:BoundField DataField="NguoiSuDungId" HeaderText="NguoiSuDungId" ItemStyle-HorizontalAlign="Center"  HeaderStyle-HorizontalAlign="Center" />
					<asp:TemplateField>
						<HeaderTemplate>
							Chọn
		...
		<td>
			<table cellpadding="0" cellspacing="0" style="width: 100%">
				<tr>
					...
					<td align="right" style="width: 50%; text-align: right">
						<asp:Button ID="Button4" runat="server" CssClass="button" Text="Xóa" OnClick="btDelete_Click" Width="50px" OnClientClick="javascript:{return confirm('Bạn có muốn xóa KhieuNai_Watchers được chọn?');}" />
					</td>
				</tr>
			</table>
		</td>
