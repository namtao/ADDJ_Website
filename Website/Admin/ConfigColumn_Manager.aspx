<%@ Page Language="C#" MasterPageFile="~/adminNotAJAX.master" AutoEventWireup="true" Inherits="admin_configColumn_manager" Title="Untitled Page" Codebehind="configColumn_manager.aspx.cs" %>
			...
			<table cellpadding="0" cellspacing="0" style="width: 100%">
				<tr>
					...
					<td align="right" style="width: 50%; text-align: right">
						<asp:Button ID="Button2" runat="server" CssClass="button" Text="Xóa" OnClick="btDelete_Click" Width="50px" OnClientClick="javascript:{return confirm('Bạn có muốn xóa ConfigColumn được chọn?');}" />
					</td>
				</tr>
			</table>
		</td>
		...
		<td style="text-align: center">
			<asp:GridView ID="grvView" runat="server" AutoGenerateColumns="False" Width="100%"
				...
				<Columns>
					...
					<asp:BoundField DataField="ColumnName" HeaderText="ColumnName" ItemStyle-HorizontalAlign="Left"  HeaderStyle-HorizontalAlign="Center" />
					<asp:BoundField DataField="DisplayName" HeaderText="DisplayName" ItemStyle-HorizontalAlign="Left"  HeaderStyle-HorizontalAlign="Center" />
					<asp:TemplateField>
						<HeaderTemplate>
							Chọn
		...
		<td>
			<table cellpadding="0" cellspacing="0" style="width: 100%">
				<tr>
					...
					<td align="right" style="width: 50%; text-align: right">
						<asp:Button ID="Button4" runat="server" CssClass="button" Text="Xóa" OnClick="btDelete_Click" Width="50px" OnClientClick="javascript:{return confirm('Bạn có muốn xóa ConfigColumn được chọn?');}" />
					</td>
				</tr>
			</table>
		</td>
