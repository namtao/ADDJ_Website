<%@ Page Language="C#" MasterPageFile="~/Master_Default.master" AutoEventWireup="true"
    Inherits="admin_LoaiKhieuNai2PhongBan" CodeBehind="LoaiKhieuNai2PhongBan.aspx.cs" %>
                ...
                <div class="panel panel-default">
                    ...
                    <tr>
                        <td style="text-align: center">
                            <asp:Button ID="btLeaver" runat="server" CssClass="btn_style_button" Text="Xóa phòng ban chuyển xử lý được chọn >>"
                                OnClick="btLeaver_Click" />
                        </td>
                        <td style="width: 70%; text-align: center">
                            <asp:Button ID="btAdd" runat="server" CssClass="btn_style_button" Text="<< Thêm phòng ban chuyển xử lý được chọn"
                        ...
                        <td style="width: 30%; text-align: left; padding-right: 10px">
                            <asp:GridView ID="grvView" runat="server" AutoGenerateColumns="False" CssClass="table table-bordered table-hover table-striped table-condensed"
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="PhongBanName" HeaderText="Phòng ban" ItemStyle-HorizontalAlign="Left"
                            ...
                            <table border="0" width="100%">
                                ...
                                <tr>
                                    <td colspan="2">
                                        <div class="inputstyle">
                                            <div class="bg">
                                                <asp:TextBox ID="txtListTenDangNhap" ReadOnly="true" Width="100%" TextMode="MultiLine" Rows="5" runat="server"></asp:TextBox>
                                            </div>
                                        </div>
                                    </td>
                                </tr>
