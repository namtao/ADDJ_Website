<%@ Page Language="C#" MasterPageFile="~/admin/adminNotAJAX.master" AutoEventWireup="true" Inherits="admin_loaiKhieuNai2PhongBan_manager" Title="Untitled Page" Codebehind="loaiKhieuNai2PhongBan_manager.aspx.cs" %>
			...
			<table cellpadding="0" cellspacing="0" style="width: 100%">
				<tr>
					...
					<td align="right" style="width: 50%; text-align: right">
						<asp:Button ID="Button2" runat="server" CssClass="button" Text="Xóa" OnClick="btDelete_Click" Width="50px" OnClientClick="javascript:{return confirm('Bạn có muốn xóa LoaiKhieuNai2PhongBan được chọn?');}" />
					</td>
				</tr>
			</table>
		</td>
		...
		<td>
			<table cellpadding="0" cellspacing="0" style="width: 100%">
				<tr>
					...
					<td align="right" style="width: 50%; text-align: right">
						<asp:Button ID="Button4" runat="server" CssClass="button" Text="Xóa" OnClick="btDelete_Click" Width="50px" OnClientClick="javascript:{return confirm('Bạn có muốn xóa LoaiKhieuNai2PhongBan được chọn?');}" />
					</td>
				</tr>
			</table>
		</td>
