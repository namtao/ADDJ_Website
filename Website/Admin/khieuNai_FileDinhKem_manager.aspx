<%@ Page Language="C#" MasterPageFile="~/admin/adminNotAJAX.master" AutoEventWireup="true" Inherits="admin_khieuNai_FileDinhKem_manager" Title="Untitled Page" Codebehind="khieuNai_FileDinhKem_manager.aspx.cs" %>
			...
			<table cellpadding="0" cellspacing="0" style="width: 100%">
				<tr>
					...
					<td align="right" style="width: 50%; text-align: right">
						<asp:Button ID="Button2" runat="server" CssClass="button" Text="Xóa" OnClick="btDelete_Click" Width="50px" OnClientClick="javascript:{return confirm('Bạn có muốn xóa KhieuNai_FileDinhKem được chọn?');}" />
					</td>
				</tr>
			</table>
		</td>
		...
		<td style="text-align: center">
			<asp:GridView ID="grvView" runat="server" AutoGenerateColumns="False" Width="100%"
				...
				<Columns>
					...
					<asp:BoundField DataField="TenFile" HeaderText="TenFile" ItemStyle-HorizontalAlign="Left"  HeaderStyle-HorizontalAlign="Center" />
					<asp:BoundField DataField="KichThuoc" HeaderText="KichThuoc" DataFormatString="{0:0,0}" ItemStyle-HorizontalAlign="Right"  HeaderStyle-HorizontalAlign="Center" />
					<asp:BoundField DataField="LoaiFile" HeaderText="LoaiFile" ItemStyle-HorizontalAlign="Center"  HeaderStyle-HorizontalAlign="Center" />
					<asp:BoundField DataField="GhiChu" HeaderText="GhiChu" ItemStyle-HorizontalAlign="Left"  HeaderStyle-HorizontalAlign="Center" />
					<asp:BoundField DataField="URLFile" HeaderText="URLFile" ItemStyle-HorizontalAlign="Left"  HeaderStyle-HorizontalAlign="Center" />
					<asp:TemplateField>
						<HeaderTemplate>
							Chọn
		...
		<td>
			<table cellpadding="0" cellspacing="0" style="width: 100%">
				<tr>
					...
					<td align="right" style="width: 50%; text-align: right">
						<asp:Button ID="Button4" runat="server" CssClass="button" Text="Xóa" OnClick="btDelete_Click" Width="50px" OnClientClick="javascript:{return confirm('Bạn có muốn xóa KhieuNai_FileDinhKem được chọn?');}" />
					</td>
				</tr>
			</table>
		</td>
