<%@ Page Language="C#" MasterPageFile="~/admin/adminNotAJAX.master" AutoEventWireup="true" Inherits="admin_khieuNai_GiaiPhap_manager" Title="Untitled Page" Codebehind="khieuNai_GiaiPhap_manager.aspx.cs" %>
			...
			<table cellpadding="0" cellspacing="0" style="width: 100%">
				<tr>
					...
					<td align="right" style="width: 50%; text-align: right">
						<asp:Button ID="Button2" runat="server" CssClass="button" Text="Xóa" OnClick="btDelete_Click" Width="50px" OnClientClick="javascript:{return confirm('Bạn có muốn xóa KhieuNai_GiaiPhap được chọn?');}" />
					</td>
				</tr>
			</table>
		</td>
		...
		<td style="text-align: center">
			<asp:GridView ID="grvView" runat="server" AutoGenerateColumns="False" Width="100%"
				...
				<Columns>
					...
					<asp:BoundField DataField="FAQ" HeaderText="FAQ" ItemStyle-HorizontalAlign="Left"  HeaderStyle-HorizontalAlign="Center" />
					<asp:BoundField DataField="MoTa" HeaderText="MoTa" ItemStyle-HorizontalAlign="Left"  HeaderStyle-HorizontalAlign="Center" />
					<asp:BoundField DataField="Comments" HeaderText="Comments" ItemStyle-HorizontalAlign="Left"  HeaderStyle-HorizontalAlign="Center" />
					<asp:TemplateField>
						<HeaderTemplate>
							Chọn
		...
		<td>
			<table cellpadding="0" cellspacing="0" style="width: 100%">
				<tr>
					...
					<td align="right" style="width: 50%; text-align: right">
						<asp:Button ID="Button4" runat="server" CssClass="button" Text="Xóa" OnClick="btDelete_Click" Width="50px" OnClientClick="javascript:{return confirm('Bạn có muốn xóa KhieuNai_GiaiPhap được chọn?');}" />
					</td>
				</tr>
			</table>
		</td>
