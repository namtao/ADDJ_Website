<%@ Page Language="C#" MasterPageFile="~/admin/adminNotAJAX.master" AutoEventWireup="true" Inherits="admin_khieuNai_Activity_manager" Title="Untitled Page" Codebehind="khieuNai_Activity_manager.aspx.cs" %>
	...
	<tr>
		<td>
			<table cellpadding="0" cellspacing="0" style="width: 600px">
				<tr>					<td style="text-align: left; width: 250px">Chọn KhieuNaiId</td>
					<td style="text-align: left">
						<asp:DropDownList ID="ddlKhieuNaiId" AutoPostBack="true" runat="server" OnSelectedIndexChanged="ddlKhieuNaiId_SelectedIndexChanged"></asp:DropDownList>
					</td>
				</tr>
			</table>
		</td>
			...
			<table cellpadding="0" cellspacing="0" style="width: 100%">
				<tr>
					...
					<td align="right" style="width: 50%; text-align: right">
						<asp:Button ID="Button2" runat="server" CssClass="button" Text="Xóa" OnClick="btDelete_Click" Width="50px" OnClientClick="javascript:{return confirm('Bạn có muốn xóa KhieuNai_Activity được chọn?');}" />
					</td>
				</tr>
			</table>
		</td>
		...
		<td style="text-align: center">
			<asp:GridView ID="grvView" runat="server" AutoGenerateColumns="False" Width="100%"
				...
				<Columns>
					...
					<asp:BoundField DataField="PhongBanXuLyTruocId" HeaderText="PhongBanXuLyTruocId" ItemStyle-HorizontalAlign="Center"  HeaderStyle-HorizontalAlign="Center" />
					<asp:BoundField DataField="NguoiXuLyTruoc" HeaderText="NguoiXuLyTruoc" ItemStyle-HorizontalAlign="Left"  HeaderStyle-HorizontalAlign="Center" />
					...
					<asp:BoundField DataField="HanhDong" HeaderText="HanhDong" ItemStyle-HorizontalAlign="Center"  HeaderStyle-HorizontalAlign="Center" />
					...
					<asp:TemplateField HeaderText="IsCurrent">
						<ItemTemplate>
							<asp:CheckBox ID="chkIsCurrent" runat="server" Checked='<%# Convert.ToBoolean(Eval("IsCurrent")) %>' />
						</ItemTemplate>
					</asp:TemplateField>
					<asp:BoundField DataField="ActivityTruoc" HeaderText="ActivityTruoc" ItemStyle-HorizontalAlign="Center"  HeaderStyle-HorizontalAlign="Center" />
					<asp:TemplateField>
						<HeaderTemplate>
							Chọn
		...
		<td>
			<table cellpadding="0" cellspacing="0" style="width: 100%">
				<tr>
					...
					<td align="right" style="width: 50%; text-align: right">
						<asp:Button ID="Button4" runat="server" CssClass="button" Text="Xóa" OnClick="btDelete_Click" Width="50px" OnClientClick="javascript:{return confirm('Bạn có muốn xóa KhieuNai_Activity được chọn?');}" />
					</td>
				</tr>
			</table>
		</td>
