<%@ Page Language="C#" MasterPageFile="~/admin/adminNotAJAX.master" AutoEventWireup="true" Inherits="admin_khieuNai_BuocXuLy_add" Title="Untitled Page" Codebehind="khieuNai_BuocXuLy_add.aspx.cs" %>
...
<script language="javascript">
	...
	<table border="0" cellpadding="0" cellspacing="0" width="100%">
		...
		<tr>  
			...
			<td style="width:20%; text-align:left">
				<asp:TextBox ID="txtNoiDung" runat="server" Text="" TextMode="MultiLine" Height="100px" Width="450px"></asp:TextBox>
			</td>
			<td style="width:20%; text-align:left">
			</td>
			<td style="width:15%"></td>
