...
(function($) {
    ...
    function _205(_206, _207, _208, width) {
        var win = $("<div class=\"messager-body\"></div>").appendTo("body");
        win.append(_207);
        var width1 = 300;
        if (_208) {
            var tb;
            if (width == "auto") width1 = width;
            else tb = $("<div class=\"messager-button\"></div>").appendTo(win);
        ...
        win.window({ title: _206, noheader: (_206 ? false : true), width: width1, height: "auto", modal: true, collapsible: false, minimizable: false, maximizable: false, resizable: false, onClose: function() {
            setTimeout(function() {
                win.window("destroy");
            }, 100);
        }
    ...
    $.messager = { show: function(_20a) {
        var opts = $.extend({ showType: "slide", showSpeed: 600, width: 250, height: 100, msg: _20a, title: "", timeout: 4000 }, _20a || {});
        ...
        alertAuto: function(_20b, msg, icon, fn) {
            var _20c = "<div>" + msg + "</div>";
            switch (icon) {
                case "error":
                    _20c = "<div class=\"messager-icon messager-error\"></div>" + _20c;
            ...
            var win = _205(_20b, _20c, _20d, "auto");
...
$.fn.validatebox.defaults={required:false,validType:null,missingMessage:"Không để trống.",invalidMessage:null,rules:{email:{validator:function(_362){
