<%@ Page Title="" Language="C#" AutoEventWireup="true" CodeBehind="AccountLock.aspx.cs" Inherits="Website.HTHTKT.Notify.AccountLock" %>
                ...
                <div class="col-md-4 col-md-offset-4">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h3 class="panel-title" style="text-align: center">Tài khoản bị khóa</h3>
                        </div>
                        <div class="panel-body">

                            <div class="alert alert-danger">
                                <strong>Chú ý!</strong> Tài khoản của bạn đã bị khóa hoặc hết hiệu lực, vui lòng liên hệ với quản trị viên.
                            </div>
