<%@ Page Title="" Language="C#" AutoEventWireup="true" CodeBehind="NotRight.aspx.cs" Inherits="Website.HTHTKT.Notify.NotRight" %>
                ...
                <div class="col-md-4 col-md-offset-4">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h3 class="panel-title" style="text-align: center">Không có quyền</h3>
                        </div>
                        <div class="panel-body">
                            <div class="alert alert-danger">
                                <strong>Chú ý!</strong> Tài khoản của bạn không có quyền truy cập, vui lòng liên hệ với quản trị viên.
                            </div>
