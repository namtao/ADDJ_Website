<%@ Page Title="" Language="C#" AutoEventWireup="true" CodeBehind="AccountNotExist.aspx.cs" Inherits="Website.HTHTKT.Notify.AccountNotExist" %>
                ...
                <div class="col-md-4 col-md-offset-4">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h3 class="panel-title" style="text-align: center">Tài khoản không tồn tại</h3>
                        </div>
                        <div class="panel-body">
                            <div class="alert alert-danger">
                                <strong>Chú ý!</strong> Tài khoản của bạn không tồn tại trên hệ thống, vui lòng liên hệ với quản trị viên.
                            </div>
