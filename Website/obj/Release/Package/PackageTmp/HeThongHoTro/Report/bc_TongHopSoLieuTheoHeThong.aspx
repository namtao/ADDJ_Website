<%@ Page Title="" Language="C#" MasterPageFile="~/Master_Default.master" AutoEventWireup="true" CodeBehind="bc_TongHopSoLieuTheoHeThong.aspx.cs" Inherits="Website.HeThongHoTro.Report.bc_TongHopSoLieuTheoHeThong" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="ContentPlaceHolder_Text" runat="server">
    <script type="text/javascript">
        ...
        function loadBaoCao(sothuebao, hethong, linhvuc, mucdosuco, tungay, denngay, iddonvi, nguoidung,mayeucau) {
            $.ajax({
                type: 'POST',
                url: '/HeThongHoTro/Services/ws_baoCao.asmx/bc_tonghopTheoHeThong',
