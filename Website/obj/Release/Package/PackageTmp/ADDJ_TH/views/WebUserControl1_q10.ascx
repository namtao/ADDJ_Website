      ...
      <div style="width: 100%; margin: 0 auto;">
            ...
            <dx:ASPxGridView ID="grvCustomer" ClientInstanceName="grvCustomer" runat="server"
                ...
                <Columns>
                    ...
                    <dx:GridViewDataTextColumn FieldName="trichyeunoidung" Visible="false" PropertiesTextEdit-EncodeHtml="false" VisibleIndex="4" Caption="Trích yếu nội dung" CellStyle-HorizontalAlign="Center">
                    </dx:GridViewDataTextColumn>
                    <dx:GridViewDataTextColumn FieldName="trichyeunoidung_mlhs" PropertiesTextEdit-EncodeHtml="false" VisibleIndex="5" Caption="Trích yếu nội dung" CellStyle-HorizontalAlign="Center">
                    </dx:GridViewDataTextColumn>
                    <dx:GridViewDataTextColumn FieldName="soto" PropertiesTextEdit-EncodeHtml="false" VisibleIndex="6" Caption="Số tờ" CellStyle-HorizontalAlign="Center">
                    </dx:GridViewDataTextColumn>
                    <dx:GridViewDataTextColumn FieldName="thoigian" PropertiesTextEdit-EncodeHtml="false" VisibleIndex="4" Caption="Tiêu đề hồ sơ" CellStyle-HorizontalAlign="Center">
                    </dx:GridViewDataTextColumn>
                    <dx:GridViewDataTextColumn FieldName="nam" PropertiesTextEdit-EncodeHtml="false" VisibleIndex="9" Caption="Ngày ban hành">
                    </dx:GridViewDataTextColumn>
                    <dx:GridViewDataTextColumn FieldName="thoihanbaoquan" PropertiesTextEdit-EncodeHtml="false" VisibleIndex="8" Caption="Thời hạn bảo quản">
                    </dx:GridViewDataTextColumn>
                    <dx:GridViewDataTextColumn FieldName="ghichu" PropertiesTextEdit-EncodeHtml="false" VisibleIndex="10" Caption="Số lượng tờ" CellStyle-HorizontalAlign="Center">
                    </dx:GridViewDataTextColumn>
                    <dx:GridViewDataTextColumn FieldName="bosung1" PropertiesTextEdit-EncodeHtml="false" VisibleIndex="11" Caption="Số và ký hiệu" CellStyle-HorizontalAlign="Center">
                    </dx:GridViewDataTextColumn>
                     <dx:GridViewDataTextColumn FieldName="bosung2" PropertiesTextEdit-EncodeHtml="false" VisibleIndex="12" Caption="Tác giả văn bản" CellStyle-HorizontalAlign="Center">
                    </dx:GridViewDataTextColumn>
                    <dx:GridViewDataTextColumn FieldName="stt" Visible="false" PropertiesTextEdit-EncodeHtml="false" VisibleIndex="13" Caption="STT" CellStyle-HorizontalAlign="Center">
                    </dx:GridViewDataTextColumn>
                    <dx:GridViewDataTextColumn FieldName="phongdoi" PropertiesTextEdit-EncodeHtml="false" VisibleIndex="13" Caption="STT">
                    </dx:GridViewDataTextColumn>
                    <dx:GridViewDataTextColumn FieldName="mlhs" PropertiesTextEdit-EncodeHtml="false" VisibleIndex="14" Caption="MLHS">
                    </dx:GridViewDataTextColumn>
                    <dx:GridViewDataTextColumn FieldName="mst" PropertiesTextEdit-EncodeHtml="false" VisibleIndex="15" Caption="Mục lục số">
                    </dx:GridViewDataTextColumn>
                    <dx:GridViewDataTextColumn FieldName="domatkhan" PropertiesTextEdit-EncodeHtml="false" VisibleIndex="16" Caption="Tên loại văn bản">
                    </dx:GridViewDataTextColumn>
                    <dx:GridViewDataTextColumn FieldName="matokhai" PropertiesTextEdit-EncodeHtml="false" VisibleIndex="17" Caption="Kệ số">
                    </dx:GridViewDataTextColumn>
                    <dx:GridViewDataTextColumn FieldName="diachi" PropertiesTextEdit-EncodeHtml="false" VisibleIndex="18" Caption="Tầng số">
                    </dx:GridViewDataTextColumn>

                    <dx:GridViewCommandColumn VisibleIndex="19">
                        <CustomButtons>
                                    ...
                                    <PanelCollection>
                                        <dx:PanelContent runat="server">
                                            <table style="width: 100%; height: 100%;" class="thongtin_hs">
                                                <tr>
                                                    <td>
                                                        <dx:ASPxLabel ID="lblSoHop" ClientInstanceName="lblSoHop" runat="server" Text="Hộp số" Theme="Glass">
                                                        </dx:ASPxLabel>
                                                    </td>
                                                    <td>
                                                    ...
                                                    <td>
                                                        <dx:ASPxLabel ID="lblSoHoSo" ClientInstanceName="lblSoHoSo" runat="server" Text="Hồ sơ số" Theme="Glass">
                                                        </dx:ASPxLabel>
                                                    </td>
                                                    <td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <dx:ASPxLabel ID="ASPxLabel5" runat="server" Text="Ngày ban hành" Theme="Glass">
                                                        </dx:ASPxLabel>
                                                    </td>
                                                    <td>
                                                        <dx:ASPxTextBox ID="txtNgayBanHanh" runat="server" Width="170px" ClientInstanceName="txtNgayBanHanh" Theme="Glass">
                                                        </dx:ASPxTextBox>
                                                    </td>
                                                    <td>&nbsp;</td>
                                                </tr>
                                                <tr>
                                                    <td>
                                                        <dx:ASPxLabel ID="ASPxLabel6" runat="server" Text="Thời hạn bảo quản" Theme="Glass">
                                                        </dx:ASPxLabel>
                                                    </td>
                                                    <td>
                                                    ...
                                                    <td>
                                                        <dx:ASPxLabel ID="ASPxLabel13" runat="server" Text="Số lượng tờ" Theme="Glass">
                                                        </dx:ASPxLabel>
                                                    </td>
                                                    <td>
                                                        <dx:ASPxTextBox ID="txtSoLuongTo" ClientInstanceName="txtSoLuongTo" runat="server" Width="170px" Theme="Glass">
                                                        </dx:ASPxTextBox>
                                                    </td>
                                                    <td>&nbsp;</td>
                                                </tr>
                                                <tr>
                                                    <td>
                                                        <dx:ASPxLabel ID="ASPxLabel12" runat="server" Text="Số và ký hiệu" Theme="Glass">
                                                        </dx:ASPxLabel>
                                                    </td>
                                                    <td>
                                                    ...
                                                    <td>
                                                        <dx:ASPxLabel ID="ASPxLabel14" runat="server" Text="Tác giả văn bản" Theme="Glass">
                                                        </dx:ASPxLabel>
                                                    </td>
                                                    <td>
                                                        <dx:ASPxTextBox ID="txtTacGiaVanBan" ClientInstanceName="txtTacGiaVanBan" runat="server" Width="170px" Theme="Glass">
                                                        </dx:ASPxTextBox>
                                                    </td>
                                                    <td>&nbsp;</td>
                                                </tr>
                                                <tr>
                                                    <td>
                                                        <dx:ASPxLabel ID="ASPxLabel8" runat="server" Text="Ghi chú" Theme="Glass">
                                                        </dx:ASPxLabel>
                                                    </td>
                                                    <td>
                                                        <dx:ASPxTextBox ID="txtGhiChu" ClientInstanceName="txtGhiChu" runat="server" Width="170px" Theme="Glass">
                                                        </dx:ASPxTextBox>
                                                    </td>
                                                    <td>
                                                        <dx:ASPxLabel ID="ASPxLabel15" runat="server" Text="STT" Theme="Glass">
                                                        </dx:ASPxLabel>
                                                    </td>
                                                    <td>
                                                ...
                                                <tr>
                                                    <td>
                                                        <dx:ASPxLabel ID="ASPxLabel9" runat="server" Text="MLHS" Theme="Glass">
                                                        </dx:ASPxLabel>
                                                    </td>
                                                    <td colspan="3">
                                                        <dx:ASPxTextBox ID="txtMLHS" ClientInstanceName="txtMLHS" runat="server" Theme="Glass" ></dx:ASPxTextBox>
                                                    </td>
                                                    <td>&nbsp;</td>
                                                </tr>
                                                <tr>
                                                    <td>
                                                        <dx:ASPxLabel ID="ASPxLabel16" runat="server" Text="Mục lục số" Theme="Glass">
                                                        </dx:ASPxLabel>
                                                    </td>
                                                    <td>
                                                        <dx:ASPxTextBox ID="txtTenLoaiVanBan" ClientInstanceName="txtTenLoaiVanBan" runat="server" Width="170px" Theme="Glass">
                                                        </dx:ASPxTextBox>
                                                    </td>
                                                    <td></td>
                                                    <td></td>
                                                ...
                                                <tr >
                                                    <td>
                                                        <dx:ASPxLabel ID="ASPxLabel10" runat="server" Text="Tên loại văn bản" Theme="Glass">
                                                        </dx:ASPxLabel>
                                                    </td>
                                                    <td>
                                                        <dx:ASPxTextBox ID="txtMucLucSo" ClientInstanceName="txtMucLucSo" runat="server" Width="170px" Theme="Glass">
                                                        </dx:ASPxTextBox>
                                                    </td>
                                                    <td>
                                                        <dx:ASPxLabel ID="ASPxLabel17" runat="server" Text="Kệ số" Theme="Glass">
                                                        </dx:ASPxLabel>
                                                    </td>
                                                    <td>
                                                        <dx:ASPxTextBox ID="txtKeSo" ClientInstanceName="txtKeSo" runat="server" Width="170px" Theme="Glass">
                                                        </dx:ASPxTextBox>
                                                    </td>
                                                    <td>&nbsp;</td>
                                                </tr>
                                                <tr>
                                                    <td>
                                                        <dx:ASPxLabel ID="ASPxLabel11" runat="server" Text="Tầng số" Theme="Glass">
                                                        </dx:ASPxLabel>
                                                    </td>
                                                    <td>
                                                        <dx:ASPxTextBox ID="txtTangSo" ClientInstanceName="txtTangSo" runat="server" Width="170px" Theme="Glass">
                                                        </dx:ASPxTextBox>
                                                    </td>
                                                    <td>
                                                        <dx:ASPxLabel Visible="false" ID="ASPxLabel18" runat="server" Text="Số giấy CN" Theme="Glass">
                                                        </dx:ASPxLabel>
                                                    </td>
                                                    <td>
                                                        <dx:ASPxTextBox Visible="false" ID="txtSoGiayCN" ClientInstanceName="txtSoGiayCN" runat="server" Width="170px" Theme="Glass">
                                                        </dx:ASPxTextBox>
                                                    </td>
                                                    <td>&nbsp;</td>
                                                </tr>
                                                <tr style="display:none">
                                                    ...
                                                    <td>
                                                        <dx:ASPxTextBox ID="txtSTT1" ClientInstanceName="txtSTT1" runat="server" Width="170px" Theme="Glass">
                                                        </dx:ASPxTextBox>
                                                    </td>
                                                    <td>&nbsp;</td>
                                                </tr>
    ...
    <ContentCollection>
        <dx:PopupControlContentControl runat="server">
            <table style="width: 100%; height: 100%;" class="thongtin_hs">
                ...
                <tr>
                    <td>
                        <dx:ASPxLabel ID="ASPxLabel20" runat="server" Text="MLHS" Theme="Glass">
                        </dx:ASPxLabel>
                    </td>
                    <td colspan="3">
                        <dx:ASPxTextBox ID="txtMLHSEdit" ClientInstanceName="txtMLHSEdit" runat="server" Theme="Glass"></dx:ASPxTextBox>
                    </td>
                    <td>&nbsp;</td>
                </tr>
    ...
    <ContentCollection>
        <dx:PopupControlContentControl runat="server">
            <table style="width: 100%; height: 100%;" class="thongtin_hs">
                ...
                <tr>
                    <td>
                        <dx:ASPxLabel ID="ASPxLabel28" runat="server" Text="MLHS" Theme="Glass">
                        </dx:ASPxLabel>
                    </td>
                    <td colspan="3">
                        <dx:ASPxTextBox ID="txtMLHSAdd" ClientInstanceName="txtMLHSAdd" runat="server" Theme="Glass"></dx:ASPxTextBox>
                    </td>
                    <td>&nbsp;</td>
                </tr>
