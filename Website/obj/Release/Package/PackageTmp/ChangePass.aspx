<%@ Page Language="C#" MasterPageFile="~/master_default.master" AutoEventWireup="true" Inherits="ChangePass" CodeBehind="ChangePass.aspx.cs" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder_Main" runat="Server">
    <table border="0" cellpadding="0" cellspacing="0" width="100%">
        ...
        <tr>
            ...
            <td style="width: 15%; text-align: right; padding-right: 10px">Tên đăng nhập
            </td>
        ...
        <tr>
            <td style="width: 30%"></td>
            <td style="width: 15%; text-align: right; padding-right: 10px">Nhập lại mật khẩu
            </td>
            <td style="width: 20%; text-align: left">
