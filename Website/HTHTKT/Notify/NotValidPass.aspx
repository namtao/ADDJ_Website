<%@ Page Title="" Language="C#" AutoEventWireup="true" CodeBehind="NotValidPass.aspx.cs" Inherits="Website.HTHTKT.Notify.NotValidPass" %>
                ...
                <div class="col-md-4 col-md-offset-4">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h3 class="panel-title" style="text-align: center">Sai thông tin</h3>
                        </div>
                        <div class="panel-body">
                            <div class="alert alert-danger">
                                <strong>Chú ý!</strong> Bạn đã nhập sai thông tin tên đăng nhập hoặc mật khẩu, vui lòng nhập lại.
                            </div>
