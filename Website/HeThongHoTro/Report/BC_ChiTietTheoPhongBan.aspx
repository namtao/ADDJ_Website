<%@ Page Title="" Language="C#" MasterPageFile="~/Master_Default.master" AutoEventWireup="true" CodeBehind="BC_ChiTietTheoPhongBan.aspx.cs" Inherits="Website.HeThongHoTro.Report.BC_ChiTietTheoPhongBan" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="ContentPlaceHolder_Text" runat="server">
    <script type="text/javascript">
        ...
        function loadBaoCao(val, val2, val3, val4) {
            $.ajax({
                type: 'POST',
                url: '/HeThongHoTro/Services/ws_baoCao.asmx/bc_chitietTheoPhongBan',
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="panel panel-primary">
                        <div class="panel-heading">Báo cáo chi tiết theo Phòng ban</div>
