<%@ Page Title="" Language="C#" MasterPageFile="~/Master_Default.master" AutoEventWireup="true" CodeBehind="BC_TongHopSoLieu_YCHT_TheoNguoiDung.aspx.cs" Inherits="Website.HeThongHoTro.Report.BC_TongHopSoLieu_YCHT_TheoNguoiDung1" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="ContentPlaceHolder_Text" runat="server">
    <script type="text/javascript">
        ...
        function loadBaoCao(val, val2, val3, val4) {
            $.ajax({
                type: 'POST',
                url: '/HeThongHoTro/Services/ws_baoCao.asmx/bc_baoCaoTongHopSoLieu_YCHT_TheoNguoiDung',
                data: "{ tungay: '" + val + "',denngay: '" + val2 + "',id_donvi: '" + val3 +  "',arr_nguoidung: '" + val4 + "' }",
        ...
        function baocao() {
            ...
            var lstUser = [];
            var chkBox = document.getElementById('<%= cblNguoiDung.ClientID %>');
            if (chkBox != null) {
            ...
            loadBaoCao(tungay, denngay, id_donvi, lstUser);
        }
        function xuatExcel() {
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="panel panel-primary">
                        <div class="panel-heading">Báo cáo tổng hợp số liệu Yêu cầu hệ thống theo Người dùng</div>
