<%@ Page Title="" Language="C#" MasterPageFile="~/Master_Default.master" AutoEventWireup="true" CodeBehind="BC_ChiTietTheoNguoiDung.aspx.cs" Inherits="Website.HeThongHoTro.Report.BC_ChiTietTheoNguoiDung" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="ContentPlaceHolder_Text" runat="server">
    <script type="text/javascript">
        ...
        function loadBaoCao(val, val2, val3, val4) {
            $.ajax({
                type: 'POST',
                url: '/HeThongHoTro/Services/ws_baoCao.asmx/bc_chitietTheoNguoiDung',
                ...
                success: function (jsonData) {
                    ...
                    for (var i = 0; i < objret.length; i++) {
                        tr = $('<tr/>');
                        tr.append("<td>" + objret[i].ID_NGUOIDUNG + "</td>");
                        tr.append("<td>" + objret[i].TenTruyCap + "</td>");
                    ...
                    if (objret.length > 0) {
                        ...
                        tr = $('<tr/>');
                        tr.append("<td colspan='9'>Không có dữ liệu</td>");
                        $("#timeLine tbody").append(tr);
                    }
                    loadingdata.Hide();
                },
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="panel panel-primary">
                        <div class="panel-heading">Báo cáo chi tiết theo Người dùng</div>
