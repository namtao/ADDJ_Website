...
{
    public partial class mn_DmDauMoiXL : System.Web.UI.Page
    {
            ...
            if (tbl == null)
            {
                ...
                if (loginInfo != null)
                {
                    using (var ctx = new ADDJContext())
                    {
                        ...
                        if (idht != "0" && idht != "")
                        {
                            strIDHeThong = string.Format(@" and hdx.ID_HETHONG={0} ", idht);
                        }
                        ...
                        var strSQl = @"SELECT hdx.ID
                                      ...
                                      LEFT JOIN HT_DONVI hd ON hd.ID=hdx.ID_DONVI where hdhy.trangthai=1 " + strIDHeThong;
