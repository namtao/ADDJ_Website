<%@ Page Title="" Language="C#" MasterPageFile="~/Master_Default.master" AutoEventWireup="true" CodeBehind="mn_ThietLapQuyenNhom.aspx.cs" Inherits="Website.HeThongHoTro.Manager.mn_ThietLapQuyenNhom" %>
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body" style="border: none">
                <div class="container-fluid" style="margin-left: 0px">
                    <div class="row">
                        <div class="col-md-2"><strong>Danh sách nhóm quyền</strong></div>
                        <div class="col-md-10">
                            <strong>Phân quyền menu
                                <dx:ASPxLabel ID="lblTenDonVi" ForeColor="LightCoral" ClientInstanceName="lblTenDonVi" runat="server" Text="(Danh sách các quyền thuộc nhóm đã chọn)"></dx:ASPxLabel>
                            </strong>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="col-md-2">
                            <div style="height: 350px;">
                                ...
                                <dx:ASPxListBox ID="lstQuyen" ValueField="Id" runat="server" ValueType="System.String"
                                    Theme="Office2010Blue"  Width="200px" Height="200px">
                                    <Columns>
                                        <dx:ListBoxColumn FieldName="Name" Caption="Quyền"></dx:ListBoxColumn>
                                    </Columns>
                                    <ClientSideEvents SelectedIndexChanged='function(s,e){
                                        hiddenQuyen.Set("role",s.GetValue());
                                        chonquyen(s.GetValue());
                                        }' />
