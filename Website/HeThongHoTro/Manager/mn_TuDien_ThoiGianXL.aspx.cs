...
{
    public partial class mn_TuDien_ThoiGianXL : System.Web.UI.Page
    {
        ...
        {
            var tbl = Session["tblHeThongXL"] as List<HT_TUDIEN_THOIGIAN_XL>;
            if (tbl == null)
            {
                ...
                if (loginInfo != null)
                {
                    using (var ctx = new ADDJContext())
                    {
                        ...
                        var strSQl = @"SELECT httx.ID
                                      ,httx.TG_TOITHIEU
                                      ,httx.TG_TOIDA
                                      ,httx.TRANGTHAI
                                      ,httx.NGUOITAO
                                      ,httx.NGAYTAO 
                                      FROM HT_TUDIEN_THOIGIAN_XL httx" + strIDHeThong;
                        var lstHoTro = ctx.Database.SqlQuery<HT_TUDIEN_THOIGIAN_XL>(strSQl);
